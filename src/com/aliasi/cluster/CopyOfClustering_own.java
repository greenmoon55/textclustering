...
public class CopyOfClustering_own {
	...
	public static void main(String[] args) throws IOException {
        ...
        String inputStrings="apple,orange,camera,radio";
        for (String s : inputStrings.split(",")) {
            inputSet.add(s);
        //System.out.println(s);
        }
        CopyOfClustering_own clustering_own=new CopyOfClustering_own();
        Dendrogram<String> dendrogram_single= clustering_own.single_linkage_clustering(inputSet,"v");
        
////////////////////////////////////
        Set<Set<String>> clKClustering=dendrogram_single.partitionDistance(80);
        System.out.println("clustering with similarity 80");
        System.out.println(clKClustering);
        
        
        Dendrogram<String> dendrogram_complete= clustering_own.complete_linkage_clustering(inputSet,"v");
        ...
        Set<Set<String>> slKClustering=dendrogram_single.partitionDistance(1);
        System.out.println(" partitionDistance is " + slKClustering);
        //LeafDendrogram 的属性
	...
	public Dendrogram<String> single_linkage_clustering(Set<String> elementSet,String type) throws IOException {
	...
	/*	 打印   pairScore  ps(chicken,car:50.0)    ps(chicken,orange:40.0) 
		 for (PairScore<String> pairScore : pairScoreList) {
			System.out.println("the pair score is: "+pairScore);
		}
	*/
	...
	public Dendrogram<String> complete_linkage_clustering(Set<String> elementSet,String type) throws IOException {
		//空字符串的情况，报错
		if (elementSet.size() == 0) {
			String msg = "Require non-empty set to form dendrogram."
					+ " Found elementSet.size()=" + elementSet.size();
